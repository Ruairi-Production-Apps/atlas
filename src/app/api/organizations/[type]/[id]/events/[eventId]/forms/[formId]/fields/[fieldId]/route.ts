...
export async function PATCH(
    ...
    try {
        ...
        if (body.address_config !== undefined) updateData.address_config = body.address_config
        if (body.content_config !== undefined) updateData.content_config = body.content_config
