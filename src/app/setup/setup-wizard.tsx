...
export function InstanceSetupWizard() {
    ...
    return (
        <div className="w-full max-w-none px-4 py-12 md:px-12 lg:px-24">
            <div className="mb-12 text-center">
                <img src="/images/atlas/AtlasLogo.png" alt="Atlas" className="h-20 mx-auto mb-6" />
                <h1 className="text-4xl font-extrabold tracking-tight lg:text-5xl">Instance Setup</h1>
                <p className="text-xl text-muted-foreground mt-4 max-w-2xl mx-auto">Configure your Atlas instance to get started.</p>
            </div>
                    ...
                    {steps.map((i, idx) => (
                        <div key={i} className="flex items-center">
                            <div className={cn(
                                ...
                                step === i ? "border-primary bg-primary text-primary-foreground ring-4 ring-primary/20 scale-110" :
            ...
            {error && (
                <div className="max-w-4xl mx-auto mb-8 p-6 bg-destructive/10 border border-destructive/20 text-destructive rounded-xl text-sm font-medium flex items-center gap-3">
