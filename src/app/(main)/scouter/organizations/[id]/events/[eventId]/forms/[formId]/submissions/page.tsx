...
export default async function SubmissionsPage({ params }: PageProps) {
    ...
    const { id, eventId, formId } = resolvedParams
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <div className="mb-6 flex items-center justify-between">
                <div>
                    <Button variant="ghost" asChild className="mb-4 pl-0">
                        <Link href={`/scouter/organizations/${id}/events/${eventId}/forms`}>
            ...
            <FormSubmissionsList
                ...
                eventId={eventId}
                organizationId={id}
                organizationType="group" // Assuming group context for now, ideally dynamic
            />
        </div>
    )
}
